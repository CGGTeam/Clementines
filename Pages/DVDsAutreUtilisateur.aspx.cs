        ...
        if (nbPages > 1)
        {
            ...
            string strDebut = "<nav class='text-center'>" +
                                    "<ul class='pagination justify-content-center'>" +
                                        "<li class='" + strClass + "'><a class='page-link' href='?Page=" + previous + "&Utilisateur=" + noUtilisateurVisionne + "'> <span class='glyphicon glyphicon-chevron-left'></a></li>";
            ...
            string strFin = "<li class='" + strClass + "'><a class='page-link' href='?Page=" + next + "&Utilisateur=" + noUtilisateurVisionne + "'><span class='glyphicon glyphicon-chevron-right'></a></li>" +
                                    "</ul>" +
                                "</nav>";
            pager.Text += strFin;
